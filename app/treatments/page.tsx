...
export const metadata = {
  ...
  description: 'View before and after photos of treatments performed by Dr. Aparana Ghosh. See real results from laser hair reduction, cosmetic gynecology, and other procedures.',
}
